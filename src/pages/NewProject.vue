<template>
  <div class="max-w-3xl mx-auto p-6 bg-[#161B22] rounded-xl border border-[#30363D]">
    ...
    <form @submit.prevent="submitProject" enctype="multipart/form-data" class="space-y-6">
      ...
      <!-- Image Upload -->
      <div>
        <label class="block mb-2 text-sm font-medium text-[#C9D1D9]">Project Image</label>
...
const submitProject = async () => {
  ...
  try {
    ...
    console.error('🚨 submitProject error:', errData || err)
    alert(errData?.message || 'Server error creating project')
  } finally {
